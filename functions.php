...
function _s_scripts() {
	...
	wp_enqueue_style('law-style', get_template_directory_uri() . '/css/style.css');
	wp_enqueue_style('flexslider', get_template_directory_uri() . '/css/flexslider.css');
	wp_enqueue_style('font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css');
	wp_enqueue_style('font-tmp', get_template_directory_uri() . '/css/iconos-style.css');
	wp_enqueue_style('tmp-style', get_template_directory_uri() . '/css/tmp-style.css');
	wp_enqueue_style('tmp-mediaqueries', get_template_directory_uri() . '/css/media-queries.css');
    ...
    wp_enqueue_script( 'flexslider', get_template_directory_uri() . '/js/jquery.flexslider.js', array( 'jquery' ), 'v3.3.5', true );
    wp_enqueue_script( 'affix', get_template_directory_uri() . '/js/affix.js', array( 'jquery' ), 'v3.3.5', true );
    wp_enqueue_script( 'tmp-js', get_template_directory_uri() . '/js/tmp.js', array( 'jquery' ), 'v3.3.5', true );
}
